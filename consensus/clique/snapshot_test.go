...
// mapped from textual names used in the tests below to actual Ccmchain private
...
// address retrieves the Ccmchain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Ccmchain address
