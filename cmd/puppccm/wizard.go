...
type wizard struct {
	...
	services map[string][]string   // Ccmchain services known to be running on servers
...
// converts it to an Ccmchain address. If an empty line is entered, the default
// value is returned.
