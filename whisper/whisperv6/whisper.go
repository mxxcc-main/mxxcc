...
// Whisper represents a dark communication interface through the Ccmchain
...
// New creates a Whisper client ready to communicate through the Ccmchain P2P network.
