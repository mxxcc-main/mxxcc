...
func (pm *ProtocolManager) removePeer(id string) {
	...
	// Unregister the peer from the downloader and Ccmchain peer set
...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	// Execute the Ccmchain handshake
	var (
...
// NodeInfo represents a short summary of the Ccmchain sub-protocol metadata
// known about the host peer.
type NodeInfo struct {
	Network    uint64              `json:"network"`    // Ccmchain network ID (1=Frontier, 2=Morden, Ropsten=3, Rinkeby=4)
