...
// faucet is a Ccmchain faucet backed by a light client.
package main
...
var (
	...
	payoutFlag  = flag.Int("faucet.amount", 1, "Number of Ccmchains to pay out per user request")
...
func main() {
	...
	for i := 0; i < *tiersFlag; i++ {
		...
		amounts[i] = fmt.Sprintf("%s Ccmchains", strconv.FormatFloat(amount, 'f', -1, 64))
		if amount == 1 {
...
// apiHandler handles requests for Ccmchain grants and transaction statuses.
