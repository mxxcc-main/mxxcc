...
// Package graphql provides a GraphQL interface to Ccmchain node data.
package graphql
...
// Account represents an Ccmchain account at a particular block.
type Account struct {
...
// Transaction represents an Ccmchain transaction.
...
// Block represents an Ccmchain block.
...
type CallData struct {
	From     *common.Address // The Ccmchain address the call is from.
	To       *common.Address // The Ccmchain address the call is to.
