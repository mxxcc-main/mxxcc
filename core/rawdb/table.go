...
func NewTable(db ccmdb.Database, prefix string) ccmdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator() ccmdb.Iterator {
...
// not exist).
func (t *table) NewIteratorWithStart(start []byte) ccmdb.Iterator {
	return t.db.NewIteratorWithStart(start)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) ccmdb.Iterator {
...
func (t *table) NewBatch() ccmdb.Batch {
...
func (b *tableBatch) Replay(w ccmdb.KeyValueWriter) error {
