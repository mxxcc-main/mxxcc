...
type Options struct {
	...
	// ErrorIfExist defines whccmer an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whccmer an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whccmer block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whccmer to sync underlying writes from the OS buffer cache
