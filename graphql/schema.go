...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Ccmchain address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Ccmchain account at a particular block.
    type Account {
    ...
    # Transaction is an Ccmchain transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Ccmchain account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Ccmchain account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Ccmchain block by number or by hash. If neither is
