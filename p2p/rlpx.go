...
import (
	...
	"github.com/ccmchain/go-ccmchain/crypto/ecies"
...
// and also verifies whccmer the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whccmer read packet had plain format.
