...
// See https://github.com/ccmchain/EIPs/issues/176 for the test format specification.
...
func MakePreState(db ccmdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/ccmchain/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
