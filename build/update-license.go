...
Please review the resulting diff to check whccmer the correct
...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/ccmchain/go-ccmchain/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-ccmchain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-ccmchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-ccmchain library"
	}
	return "the go-ccmchain library"
}
