...
type checkpointOracle struct {
	...
	// Whccmer the contract backend is set.
	running int32
...
// isRunning returns an indicator whccmer the registrar is running.
...
// checks whccmer there are enough approvals to finalize the checkpoint.
