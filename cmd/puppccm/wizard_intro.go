...
// setting up a new or managing an existing Ccmchain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppccm, your Ccmchain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Ccmchain network down to  |")
	...
	log.Info("Administering Ccmchain network", "name", w.network)
