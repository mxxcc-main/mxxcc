...
// in order to distinguish whccmer current folder should be re-registered in
...
// watched is made in order to check whccmer an action comes from a directory or
...
// gensys decides whccmer the Windows action, system-independent event or both
