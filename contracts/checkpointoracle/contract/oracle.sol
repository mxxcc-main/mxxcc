 ...
 * @author Gary Rong<garyrong@ccmchain.org>, Martin Swende <martin.swende@ccmchain.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the ccmchain.
    uint sectionSize;
