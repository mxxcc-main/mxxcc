...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Ccmchain
...
func (ccm *Ccmchain) startBloomHandlers(sectionSize uint64) {
...
// for the Ccmchain header bloom filters, permitting blazing fast filtering.
