...
// Contains reports whccmer the given IP is contained in the list.
...
// IsLAN reports whccmer an IP is a local network address.
...
// IsSpecialNetwork reports whccmer an IP is located in a special-use network range
...
// CheckRelayIP reports whccmer an IP relayed from the given sender IP
...
// SameNet reports whccmer two IP addresses have an equal prefix of the given bit length.
...
// Contains whccmer the given IP is contained in the set.
