...
// PrecompiledContractsHomestead contains the default set of pre-compiled Ccmchain
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Ccmchain
