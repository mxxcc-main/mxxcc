...
// account array.
func checkStateAccounts(t *testing.T, db ccmdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ccmdb.Database, root common.Hash) error {
...
func checkStateConsistency(db ccmdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(ccmdb.Database), srcRoot)
