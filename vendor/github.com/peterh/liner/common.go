...
// SetCtrlCAborts sets whccmer Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whccmer line is auto-wrapped. The default is false (single line).
...
// whccmer to retry the call to, or return the error returned by, readNext.
