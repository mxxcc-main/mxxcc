...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/ccmchain/pyccmsaletool

		pyccmsaletool generates the encryption key from password by
	...
	*/
	...
	ccmPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(ccmPriv)
