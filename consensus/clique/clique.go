...
// ecrecover extracts the Ccmchain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Ccmchain address
...
// Ccmchain testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Ccmchain address of the signing key
...
// Author implements consensus.Engine, returning the Ccmchain address recovered
