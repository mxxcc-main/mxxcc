...
type GlogHandler struct {
	...
	override  uint32 // Flag whccmer overrides are used, atomically accessible
	backtrace uint32 // Flag whccmer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whccmer this is the callsite
